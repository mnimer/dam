...
func TestParisLandmark(t *testing.T) {
	_bucket := "mikenimer-dam-playground-content"
	_name := "unit-tests/visionapi/Paris_Eiffeltwr.jpg"
	...
	if err != nil {
		...
		assert.Equal(3, len(msgBody.Metadata))
	}

}

func invokeObjectFinalizeMsg(t *testing.T, msg string) (LandmarkApiResult, error) {
