...
func TestBaliSmall(t *testing.T) {
	_bucket := "mikenimer-dam-playground-content"
	_name := "unit-tests/visionapi/bali_small.jpeg"
	...
	if err != nil {
		...
		assert.Equal(10, len(msgBody.Metadata.DominantColors.Colors))
	}
}

func invokeObjectFinalizeMsg(t *testing.T, msg string) (PropertiesApiResult, error) {
	...
	var msgBody PropertiesApiResult
